        ...
        <div class="container-fluid pt-3" style="max-width: 90%;">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-6 col-sm-12">
                    <input type="text" class="form-control" placeholder="Theme Title" id="themetitle" name="title"
            ...
            <div class="row pt-5">
                <div class="col-lg-6 col-md-5 col-sm-6" style="text-align: left;">
                    <textarea class="form-control" rows="5" name="annotation" id="themeannotation"
                        placeholder="Theme Info" data-toggle="popover" data-trigger="manual" data-placement="bottom"
                        data-content="Please add Theme Title." required></textarea>
                </div>
                <div class="col-lg-6 col-md-7 col-sm-6">
                    <div class="container-fluid p-3"
                        style="border-style: solid; border-color: blue; border-width: 1px; text-align: center;">
                        <img id="themeImage" name="image" src="images/placeholder.jpg" alt="Theme Image"
                    ...
                    <div class="form-group upload-btn-wrapper" style="text-align: right;">
                        <input type="file" class="form-control" id="imageInput" name="file" value=""
                    ...
                    if (imageInput.files.length > 0) {
                        ...
                        if (validImageTypes.includes(selectedFile.type)) {
                            ...
                            reader.onload = function (e) {
                                themeImage.src = e.target.result;
                                imageName.innerText = 'Image Name: ' + selectedFile.name;
                            };
                            ...
                            themeImage.src = 'images/placeholder.jpg'; // Reset to placeholder image
                            imageName.innerText = 'Image Name: '; // Reset image name
