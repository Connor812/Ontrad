...
<body>
    ...
    <div class="button-wrap p-5">
        <button class="prev carousel-btn mr-2" onclick="scrollHorizontally(-1)" style="cursor: pointer; color:gold;">
            <h1>❮</h1>
        </button>
                    ...
                    <div class="test-card shadow bg-body-tertiary rounded" style="min-width: 200px;">
                        <a href="song1.php?id=<?= base64_encode(random_bytes(3)) ?>">
                            ...
                            <div class="card-body p-2" style="color: black;">
                                <h6 class="card-title m-0 pb-1 " style="color: black">
                                    <?= "This is where the title of the song goes" ?>
                                </h6>
                                <p class="small pb-2"><small>Some quick example text to build on the card title and make up
                                        the bulk of the card's content.</small></p>
        ...
        <button class="next carousel-btn ml-2" onclick="scrollHorizontally(1)" style="cursor: pointer; color:gold;">
            <h1>❯</h1>
        </button>
    </div>
