...
?>
    ...
    <body>
        ...
        <div class="introbox pt-4 ontragreen ontradbg1">
            <div style="text-align: center;">
                ...
                <div class="row" style="text-align: center; padding-left: 5%; padding-right: 5%;">
                    ...
                    echo ($row['theme_image'] != NULL || !empty($row['theme_image'])) && file_exists($completePath) ?
                        "<div class='col-md-6'> <img src='themeimage_uploads/" . $row['theme_image'] . "' style='width: 80%; border-radius: 10px;'></div>" : " <div class='col-md-6'></div>";
                    ?>
                    <div class="col-md-6 m-0 py-0 px-0">
            ...
            <hr style="border-color:black; margin: 2% 5%; color:black; ">
